    ...
    <body>
        <div class="container">
            <div class="hero-unit">
                ...
                <p>Your Java application is now running on the host &ldquo;<?php echo gethostname(); ?>&rdquo;in your own dedicated environment in Nutanix Cloud for ICBC DEMO.</p>
